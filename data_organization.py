...
def match_to_db(id, ref_list):
    for elem in ref_list["data"]:
        for inst in elem["instances"]:
            if inst["primary_id"] == id or inst["secondary_id"] == id:  # these cases may need to be handled separately
...
with open("EBI_Database_Consolidated_2020-07-06.txt") as rt:
    ...
    with open("Not_downloaded.txt", 'w') as nd:
        json.dump(ref_table_copy, nd, indent=4)
